...
- [ ] 8.3 Update the multi-stage Docker build to build and install wheels rather than workspace source paths; prove the production image includes module manifests, fixtures needed at runtime, templates, catalogs, static assets, migrations, and only one non-root application process. *(In progress; see `docs/handoffs/2026-08-16-modular-core-architecture.md`.)*
