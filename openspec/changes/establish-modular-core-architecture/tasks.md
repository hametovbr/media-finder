...
- [ ] 2.8 Add RED SDK tests for an optional typed `MetadataEditor` sub-capability covering structured import, identity validation, bounded episode-table merge, standardized errors, lifecycle cleanup, capability/factory mismatch, and absence of core/control dependencies.
